...
　【アプリの使用】 ※ Windowsのみ  
１、このページ右上の [Clone or download] → [Download ZIP] → ファイルを解凍する  
...
　  
　　Q. 一覧表示にそのまま文字を記入したらエラーになる。  
　　A. [追加][変更]などボタンを押してから操作してください  
　　　 記述した内容を消し、その項目を[削除]ボタンで削除すると元に戻ります。  
　　※ おしい所まで来ているので技術が追いつき次第修正致します。
